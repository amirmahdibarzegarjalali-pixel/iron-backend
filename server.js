...
body{font-family:'Vazirmatn',Tahoma,sans-serif;background:radial-gradient(circle at 50% -10%, rgba(61,220,116,0.08), transparent 55%), var(--bg);color:var(--text);margin:0;padding:0;min-height:100vh;}
