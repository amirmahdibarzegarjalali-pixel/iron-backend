...
function render(){
  ...
  if(canSee("payments")){ loadCodes(); loadPlans(); loadDiscounts(); loadPayments(); }
  ...
  if(canSee("content")){ loadNotificationsAdmin(); loadContentList(); loadAdsList(); }
}
