...
function render(){
  ...
  app.innerHTML='<div style="max-width:900px;margin:0 auto;">'+
    ...
    '</div>'+
  '</div>';
  loadStats(); loadUsers(); loadCodes(); loadPlans(); loadDiscounts(); loadPayments(); loadAiSettings(); loadCommission(); loadAllCoaches(); loadCoachReports(); loadCoachPlansEditor(); loadCoachPrograms(); loadTickets(); loadQuickReplies(); loadCoachWallets();
}
